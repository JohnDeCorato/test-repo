...
gwc::GestureEvent::GestureEvent(GestureEvent& other) {
	ID = other.ID;
	gesture_type = other.gesture_type;
	gesture_id = other.gesture_id;
	//xml_snippet = other.xml_snippet;
	target = other.target;
	source = other.source;
	n = other.n;
	hold_n = other.hold_n;
...
gwc::GestureEvent& gwc::GestureEvent::operator= (const GestureEvent& other) {
	if(this != &other) {
		...
		//this->xml_snippet = other.xml_snippet;
...
gwc::IntermediateGestureEvent::IntermediateGestureEvent(const IntermediateGestureEvent& e){
	...
	//xml_snippet = NULL;
	//if(e.xml_snippet){
	//	xml_snippet = (char*) LocalAlloc(LPTR, sizeof(char) * (1 + strlen(e.xml_snippet)));
	//	std::strncpy(xml_snippet, e.xml_snippet, strlen(e.xml_snippet));
	//}
	target = NULL;
	if(e.target){
...
gwc::IntermediateGestureEvent& gwc::IntermediateGestureEvent::operator= (const gwc::IntermediateGestureEvent& other){
	if(this != &other){
		...
		//if(this->xml_snippet != NULL){ LocalFree(xml_snippet); xml_snippet = NULL; }
		...
		//if(other.xml_snippet){
		//	this->xml_snippet = (char*) LocalAlloc(LPTR, sizeof(char) * (1 + strlen(other.xml_snippet)));
		//	std::strncpy(this->xml_snippet, other.xml_snippet, strlen(other.xml_snippet));
		//}	
...
gwc::IntermediateGestureEvent::~IntermediateGestureEvent(){
	...
	//if(xml_snippet != NULL){ LocalFree(xml_snippet); }
...
gwc::GestureEvent::GestureEvent(IntermediateGestureEvent intermediary) {
	...
	//xml_snippet = std::string(intermediary.xml_snippet);
