...
typedef void (*closeGestureWorksType)(void);
...
static closeGestureWorksType _closeGestureWorks(0);
...
int loadGestureWorks(std::string dll_path) {
	...
	if(gwcDLL != NULL) {
		...
		//_closeGestureWorks = (closeGestureWorksType) GetProcAddress(gwcDLL, "closeGestureWorks");
