...
#include "ofMain.h"
#include "Hello TUIO.h"

//This vector keeps track of the points to be displayed on screen
std::map<int,gwc::Point> active_points;

//Our TUIO event interpreter and client
touchListener listener;
TuioClient tuio_client(3333);



//Thread function necessary to continuously listen for TUIO events
