...
"""
from GWCUtils import _PointEventArray, _GestureEventArray, GestureEvent, TouchpointEvent
...
class GestureWorksCore:
    ...
    def addEvent(self, touchpoint_event):
        assert type(touchpoint_event) == TouchpointEvent
        self._dll.addEvent(touchpoint_event)