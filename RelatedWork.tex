...
\subfigure[Beginning the sketch]{\label{fig:catia1}\includegraphics[width=60mm]{CATIA1}}
\subfigure[Finishing the sketch]{\label{fig:catia2}\includegraphics[width=60mm]{CATIA2}}
...
\begin{figure}
\centering     %%% not \center
\subfigure[Using the tablet to draw]{\label{fig:hyve1}\includegraphics[width=60mm]{Hyve3D1}}
\subfigure[Manipulating the drawing plane]{\label{fig:hyve2}\includegraphics[width=60mm]{Hyve3D2}}
